...
const contractABI = require("../artifacts/contracts/Broadcastlens.sol/Broadcastlens.json").abi;

program
    .name("broadcastlens-cli")
    .description("CLI tool for Broadcastlens smart contract")
    .version("1.0.0");
